            ...
            {!appliedCoupon ? (
                <div className={`flex`}>
                    <input
                        ...
                        className={`w-[75%] border border-[#00000033] rounded-md px-3 py-2 text-sm focus:outline-none ${isRTL ? 'rounded-l-none' : 'rounded-r-none'}`}
                    />
                    <button
                        onClick={handleApplyCoupon}
                        className={`flex items-center justify-center text-sm gap-1.5 w-[25%] px-4 py-2 bg-[#B0438A] font-medium text-white rounded-md ${isRTL ? 'rounded-r-none' : 'rounded-l-none'}`}
                    >
