...
export default function InputField({ label, icon: Icon, value, onChange, disabled = false }: InputFieldProps) {
    return (
        <div className="flex items-center border border-[#00000033] rounded-lg h-12 px-4 justify-between">
            <div className="flex flex-row gap-4 w-[95%] justify-center items-center relative">
                ...
                <div className="w-full">
                    <label className="absolute text-[#00000099] text-[8px] font-light top-0 left-0">
                        {label}
                    </label>
                    <input
                        type="text"
